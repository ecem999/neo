...
export default function AramaMotoruOptimizasyonuPage() {
  return (
    <div className="relative min-h-screen">
      ...
      <ServiceDetailHero 
        ...
        description="Web siteniz için, hedef kitlenizin markanızı arama motorlarında daha kolay bulması için performans odaklı anahtar kelime stratejisi sunuyoruz."
        imageSrc="/seo1.png"
      />
      <SeoRichContent />
      <OtherServicesTags activeTag="Arama Motoru Optimizasyonu" />
      <Portfolio />
    </div>
  );
}
